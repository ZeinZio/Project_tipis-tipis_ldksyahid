...
Route::delete('/user/cv/education/{id}', [\App\Http\Controllers\CvController::class, 'destroyEducation'])->name('user.cv.destroyEducation')->middleware(['auth']);

Route::post('/user/cv/experience', [\App\Http\Controllers\CvController::class, 'storeExperience'])->name('user.cv.storeExperience')->middleware(['auth']);
Route::delete('/user/cv/experience/{id}', [\App\Http\Controllers\CvController::class, 'destroyExperience'])->name('user.cv.destroyExperience')->middleware(['auth']);

Route::post('/user/cv/skill', [\App\Http\Controllers\CvController::class, 'storeSkill'])->name('user.cv.storeSkill')->middleware(['auth']);
Route::delete('/user/cv/skill/{id}', [\App\Http\Controllers\CvController::class, 'destroySkill'])->name('user.cv.destroySkill')->middleware(['auth']);

Route::get('/verify-cv/{hash}', [\App\Http\Controllers\CvController::class, 'verifyCv'])->name('verify.cv');
...
Route::post('/user/portfolio', [\App\Http\Controllers\PortfolioController::class, 'store'])->name('user.portfolio.store')->middleware(['auth']);
Route::delete('/user/portfolio/{id}', [\App\Http\Controllers\PortfolioController::class, 'destroy'])->name('user.portfolio.destroy')->middleware(['auth']);
Route::get('/user/portfolio/download-zip', [\App\Http\Controllers\PortfolioController::class, 'downloadZip'])->name('user.portfolio.downloadZip')->middleware(['auth']);

// Route User Portfolio Builder (PDF/Creative)
Route::get('/user/portfolio/pdf', [\App\Http\Controllers\PortfolioController::class, 'pdfBuilder'])->name('user.portfolio.pdf')->middleware(['auth']);
Route::post('/user/portfolio/template', [\App\Http\Controllers\PortfolioController::class, 'updateTemplate'])->name('user.portfolio.updateTemplate')->middleware(['auth']);
Route::get('/user/portfolio/stream', [\App\Http\Controllers\PortfolioController::class, 'stream'])->name('user.portfolio.stream')->middleware(['auth']);
Route::get('/user/portfolio/download', [\App\Http\Controllers\PortfolioController::class, 'download'])->name('user.portfolio.download')->middleware(['auth']);
