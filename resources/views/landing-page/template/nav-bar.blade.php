            ...
            @else
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-fun">
                        ...
                        <li>
                            <a href="/user/dashboard" class="dropdown-item {{ request()->is('user/dashboard') ? 'active' : '' }}">
                                <div class="dropdown-icon" style="background: rgba(0, 167, 157, 0.1); color: #00a79d;"><i class="fas fa-id-badge"></i></div>
                                <div class="dropdown-text">
                                    <span class="dropdown-title">Dashboard Aku</span>
                                    <span class="dropdown-desc">Kelola CV & Portfolio</span>
                                </div>
                            </a>
                        </li>
    ...
    <div class="mobile-menu-body">
        ...
        <div class="mobile-actions">
            ...
            @else
                ...
                <a href="/user/dashboard" class="btn-mobile-outline" style="border-color: #00a79d; color: #00a79d;"><i class="fas fa-id-badge"></i>Dashboard</a>
